...
int main(void)
{
  ...
  // One column/row set
  MAX7219_Clear();
  MAX7219_Write(0x01, 0xFF);
  HAL_Delay(2000);

  //Turn on all rows/colums
  MAX7219_Clear();
  MAX7219_Fill();
  HAL_Delay(2000);
  ...
  //diagonal line
  MAX7219_Clear();
  MAX7219_Write(0x01, 0x80);
  MAX7219_Write(0x02, 0x40);
  MAX7219_Write(0x03, 0x20);
  MAX7219_Write(0x04, 0x10);
  MAX7219_Write(0x05, 0x08);
  MAX7219_Write(0x06, 0x04);
  MAX7219_Write(0x07, 0x02);
  MAX7219_Write(0x08, 0x01);
  HAL_Delay(2000);

  //MAX7219_NumberSequenceTest();

  //MAX7219_Clear();
  //MAX7219_AlphabetSequenceTest();

  //MAX7219_DisplayNumber(0);



  MAX7219_DisplayChar('A');
  MAX7219_Clear();
