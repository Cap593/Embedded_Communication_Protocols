...
int main(void)
{
  ...
  /* USER CODE BEGIN 1 */
	...
	//W25Q
	uint8_t jedec_id[3];
	uint8_t w25q_status[2];
	uint8_t w25q_buffer[8] = {0,0,0,0,0,0,0,0};
  ...
  //Programming sequence - Erase sector,program page, read data
  W25Q_FlashSectorErase(W25Q_TEST_ADDR);
  W25Q_FlashPageProgram(W25Q_TEST_ADDR,tx_data,5);
  W25Q_FlashRead_Data(W25Q_TEST_ADDR, rx, 5);
