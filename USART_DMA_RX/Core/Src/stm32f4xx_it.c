...
{
	// checking for data in register
	if(USART2->SR & USART_SR_RXNE)
	{
		// for wrapping condition, head reaching tail in circular buffer
	...
	if(USART2->SR & USART_SR_TC)
	{
	    ...
	    //clear transmit completion status
	    USART2->SR &= ~USART_SR_TC;

		//clear transmit completion interrupt
